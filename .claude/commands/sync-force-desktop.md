Sync the desktop when it has uncommitted changes AND GitHub has newer commits.

This command:
1. Stashes (temporarily saves) your uncommitted desktop changes
2. Pulls the latest from GitHub
3. Reapplies your desktop changes on top
...
- If successful: "Synced successfully. Your desktop changes have been reapplied on top of the pulled changes."
...
**Important:** Remind the user to run `/backup-desktop` after resolving any conflicts to push the combined changes.
